	...
	final class ICPD_Promo {
		...
		public function __construct( $pref = '' ) {
			...
			$plugins_arr = [ 
				[ 
					...
					'desc' => __( 'Сreates a XML-feed to upload to Google Merchant Center', 'import-from-yml' ),
				...
				[ 
					...
					'desc' => __( 'Imports products from YML to your shop', 'import-from-yml' ),
					'url' => 'https://wordpress.org/plugins/import-from-yml/'
				],
				[ 
				...
				[ 
					...
					'desc' => __( 'Сreates a XML-feed for importing your products to Hotline', 'import-from-yml' ),
				...
				[ 
					'name' => 'XML for Avito',
					'desc' => __( 'Сreates a XML-feed for importing your products to', 'import-from-yml' ),
		...
		public function print_view_html_plugins_list_block( $pref ) {
			...
			<div class="metabox-holder">
				<div class="postbox">
					<h2 class="hndle">
						<?php esc_html_e( 'My plugins that may interest you', 'import-from-yml' ); ?>
					</h2>
					<div class="inside">
						<?php
		...
		private function print_view_html_plugins_list_item( $data_arr ) {
			printf( '<p><span class="icpd_bold">%1$s</span> - %2$s. <a href="%3$s" target="_blank">%4$s</a>.</p>%5$s',
				...
				esc_html__( 'Read more', 'import-from-yml' ),
				PHP_EOL
			);
		}
